...
const caseStudies = [
	...
	},
	{
		...
		description:
			'Migrated a legacy CMS to a modern headless architecture, improving performance and content management workflows.',
	...
	},
	{
		...
		description:
			'Built a cloud-based IoT platform to manage and monitor thousands of connected smart home devices in real-time.',
				...
				<section className="py-16 md:py-20 bg-gray-800">
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						...
						<p className="text-xl text-gray-300">
							See how we&apos;ve transformed businesses with our innovative
							solutions.
						</p>
					</div>
				</section>
